package com.devmobile.game.scenes.Testing;
...
public class TestingCharacter extends Rectangle {
    ...
    public TestingCharacter(ObjectMap<String, Array<TextureAtlas.AtlasRegion>> animations, String name, World world){
        this.world = world;
        this.name = name;
        setWidth(32);
        setHeight(32);
